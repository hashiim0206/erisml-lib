...
\title{Quantum Normative Dynamics:\\A Quantum Field Theory of Ethical Reality}
...
\noindent\textbf{Data Availability:} Code and data will be made available upon acceptance.
...
\noindent\textbf{CRediT Statement:} Anonymous Author: Conceptualization, Methodology, Formal Analysis, Investigation, Writing --- Original Draft, Writing --- Review \& Editing, Software.
\noindent\rule{\linewidth}{0.4pt}
\normalsize
\vspace{1em}
...
[Anonymous], ``Noether's Theorem for Ethics: Harm Accounting and the Formal Structure of Normative Coherence,'' manuscript, 2025.
...
[Anonymous], ``A Categorical Framework for Verifying Representational Consistency in Machine Learning Systems,'' submitted to \emph{IEEE Transactions on Artificial Intelligence}, 2025.
