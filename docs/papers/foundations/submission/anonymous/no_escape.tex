...
\bibitem{bond2025sge}
[Anonymous] (2025). Stratified Geometric Ethics: Foundations for Verifiable AI Ethics. \textit{Artificial Intelligence Journal} (submitted).

\bibitem{bond2025eip}
[Anonymous] (2025). Philosophy Engineering: A Technical Whitepaper on the Epistemic Invariance Principle.

\bibitem{bond2025deme}
[Anonymous] (2025). DEME 2.0: Distributed Ethical Monitoring Engine. \textit{Nature Machine Intelligence} (under review).
