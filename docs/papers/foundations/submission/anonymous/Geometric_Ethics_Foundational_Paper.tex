...
\bibitem{bond2026sge}
[Anonymous], ``Stratified Geometric Ethics: Mathematical Foundations for Verifiable Moral Reasoning in Autonomous Systems,'' v10. Technical Report, [Institution], 2025.

\bibitem{bond2026noether}
[Anonymous], ``Noether's Theorem for Ethics: Harm Accounting and the Formal Structure of Normative Coherence.'' Technical Report, [Institution], 2025.

\bibitem{bond2025eip}
[Anonymous], ``Philosophy Engineering: A Technical Whitepaper on the Epistemic Invariance Principle (EIP),'' v1.0. Technical Report, [Institution], 2025.

\bibitem{bond2026pragmatist}
[Anonymous], ``A Pragmatist Rebuttal to Logical and Metaphysical Arguments for God.'' Manuscript, [Institution], 2026.

\bibitem{bond2026dearabby}
[Anonymous], ``Dear Abby: Empirical Ethics Analysis.'' Technical Report, [Institution], 2026.
