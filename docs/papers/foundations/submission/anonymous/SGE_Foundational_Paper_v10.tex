...
repository will be made available upon acceptance.

\section{References}\label{references}

{[}1{]} [Anonymous]. Differential geometry for moral alignment. Working
paper, [Institution], 2024.

{[}2{]} [Anonymous]. DEME 2.0: Real-time ethical governance for
safety-critical autonomous systems. Working paper, [Institution], 2025.
...
{[}12{]} [Anonymous]. The Bond Invariance Principle: Temporal invariance
...
{[}15{]} [Anonymous]. Geometric Ethics: The Mathematical Structure of
Moral Reasoning, v1.14. Department of Computer Engineering, [Institution], Spring 2026.

{[}16{]} [Anonymous]. ErisML/DEME v3.0: A Library for Governed,
Foundation-Model-Enabled Agents with Tensorial Ethics.
[URL removed for blind review], 2026.
