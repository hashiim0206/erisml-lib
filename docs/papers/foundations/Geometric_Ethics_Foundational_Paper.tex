...
Geometric Ethics resolves both the alignment crisis and the metaethical impasse: moral evaluation has geometric structure; that structure can be preserved computationally; and the failure to preserve it explains the observed failure modes in both human moral philosophy and machine alignment.
